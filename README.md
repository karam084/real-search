...
# 📖 Real-Search-app <a name="about-project"></a>
...
- Download the Zip file or Clone the repo with:
   - git clone https://github.com/karam084/real-search
...
Feel free to check the [issues page](https://github.com/karam084/real-search/issues).
